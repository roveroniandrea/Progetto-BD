...
!function (t, e) {
    ...
    function c(t, e, n) {
        var i, o, s = (1 - Math.abs(2 * n - 1)) * e, r = t / 60, h = s * (1 - Math.abs(r % 2 - 1));
        switch (Math.floor(r)) {
            case 0:
                i = [s, h, 0];
                break;
    ...
    function u(t, e, n) {
        t /= 255, e /= 255, n /= 255;
        var i, o = Math.max(t, e, n), s = Math.min(t, e, n), r = o - s, h = .5 * (o + s),
    ...
    f.create = function () {
        ...
        var s = this.options.hues, r = this.options.customColors, h = r && r.length;
    ...
    f.createCloseButton = function () {
        ...
        for (var i = this.options.shades, o = this.options.hues, r = this.options.hue0, h = 0; h < i; h++) for (var a = 0; a < o; a++) {
            var c = Math.round(360 * a / o + r) % 360, u = 1 - (h + 1) / (i + 1), d = this.colorModer(c, e, u),
                p = s(d), f = h + n;
    ...
    var C = t.console, S = document.readyState;
